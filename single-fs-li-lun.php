...
<div class="maim_pages">
   <div class="main3"> <?php if (get_option('mytheme_bn_img_6')!=""): ?>
<a href="<?php echo get_option('mytheme_bn_url_6') ?>" target="_blank"> <img src="<?php echo get_option('mytheme_bn_img_6'); ?>" alt="<?php echo get_option('mytheme_bn_tit_6')?>" /></a>
   ...
   <?php endif; ?>
    <ul class="all_nav2">
        ...
        <li><a href=" <?php 
            ...
            echo get_category_link( $cat );?>">冯式理论</a> &nbsp;> &nbsp;<a><?php the_title(); ?></a></li>
     </ul>
    <div class="leftmain5">
    <div class="news_show">
