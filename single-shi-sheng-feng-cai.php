...
<div class="maim_pages">
   <div class="main3">  <?php if (get_option('mytheme_bn_img_3')!=""): ?>
<a href="<?php echo get_option('mytheme_bn_url_3') ?>" target="_blank"> <img src="<?php echo get_option('mytheme_bn_img_3'); ?>" alt="<?php echo get_option('mytheme_bn_tit_3')?>" /></a>
